        ...
        <div class="container">
            ...
            <div class="row">
              ...
              <div class="col-md-4 col-sm-6">
                <div class="full team_blog_colum">
                  <div class="it_team_img"> <img class="img-responsive" src="photo/Agadir/1.jpeg" alt="#"> </div>
              ...
              <div class="col-md-4 col-sm-6">
                <div class="full team_blog_colum">
                  <div class="it_team_img"> <img class="img-responsive" src="photo/Agadir/2.jpeg" alt="#"> </div>
                  <div class="team_feature_head">
                    <h4>CHARGE SOCIO-CULTUREL<br>Sadam Soufiani </h4>
                    <button type="button" class="btn btn-primary"><a href="mailto:Soufianisadam01@gmail.com">Contacter</a></button>
                  </div>  
                </div>
              </div> 
              ...
              <div class="col-md-4 col-sm-6">
                <div class="full team_blog_colum">
                  <div class="it_team_img"> <img class="img-responsive" src="photo/Agadir/3.jpg" alt="#"> </div>
                  <div class="team_feature_head">
          ...
          <div class="row rowX">
            ...
            <div class="row">
              ...
              <div class="col-md-4 col-sm-6">
                <div class="full team_blog_colum">
                  <div class="it_team_img"> <img class="img-responsive" src="photo/Agadir/4.jpeg" alt="#"> </div>
                  <div class="team_feature_head">
              ...
              <div class="col-md-4 col-sm-6">
                <div class="full team_blog_colum">
                  <div class="it_team_img"> <img class="img-responsive" src="photo/Agadir/5.png" alt="#"> </div>
                  <div class="team_feature_head">
                    <h4>CHARGE SPORTIF ET COMMUNICATION<br>Aiman Ali Assoumani </h4>
                    <button type="button" class="btn btn-primary"><a href="mailto:aiman28ali@gmail.com">Contacter</a></button>
                  </div>  
                </div>
              </div>
