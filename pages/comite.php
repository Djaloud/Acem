                  ...
                  <div class="panel-body">
                    ...
                    <ul style="margin-left: 10px;">
                      ...
                      <li style="margin-top:10px;">
                        <p><i class="fa fa-check-circle"></i> D’établir et soumettre au Bureau Exécutif (BE) un programme annuel ; </p>
                      </li>
                      <li>
                        <p><i class="fa fa-check-circle"></i> De prendre des initiatives pour encourager l’excellence scientifique ; </p>
                      </li>

                      <li>
                        <p><i class="fa fa-check-circle"></i> D’accompagner l’étudiant comorien dans la réussite académique ; </p>
                      </li>

                      <li>
                        <p><i class="fa fa-check-circle"></i> D’encourager la réflexion, le débat et les échanges constructifs ; </p>
                      </li>
                      <li>
                        <p><i class="fa fa-check-circle"></i> De proposer et diversifier les activités à caractère scientifique ; </p>
                      </li>
                      <li>
                        <p><i class="fa fa-check-circle"></i> D’organiser ou de coordonner les activités à caractère scientifique ;</p>
                      </li>
                      <li>
                        <p><i class="fa fa-check-circle"></i> De dresser un rapport au Bureau Exécutif après chaque activité ; </p>
                      </li>
                      <li>
                        <p><i class="fa fa-check-circle"></i> d’établir un bilan annuel à la fin de chaque année académique. </p>
                      </li>
                    </ul>
                  </div>
                </div>
                ...
                <div id="collapseOne2" class="panel-collapse collapse in">
                  <div class="panel-body">
                    ...
                    <ul style="margin-left: 10px;">
                      ...
                      <li style="margin-top:10px;">
                        <p><i class="fa fa-check-circle"></i> le programme scientifique de l’ACEM </p>
                      </li>
                      <li>
                        <p><i class="fa fa-check-circle"></i> la conception et la réalisation des activités scientifiques ; </p>
                      </li>

                      <li>
                        <p><i class="fa fa-check-circle"></i> l’orientation et l’accompagnement académique des étudiants ; </p>
                      </li>
                      ...
                      <li>
                        <p><i class="fa fa-check-circle"></i> la proposition d’activités à ses différentes structures régionales;</p>
                      </li>
