...
<!-- inner page banner -->
<div id="inner_banner" class="section inner_banner_section_meknes">
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        <div class="full">
          <div class="title-holder">
            <div class="title-holder-cell text-left">
              <h1 class="page-title">Section Meknès</h1>
              <ol class="breadcrumb">
                <li><a href="<?php echo URLROOT; ?>">Accueil</a></li>
                <li class="active">Meknès</li>
              </ol>
            </div>
          </div>
        </div>
        ...
        <div class="info_section">
          ...
          <div classe="wrapper mr-4 mb-4">
            <div class="counterSection mr-3 mb-2">
              ...
              <span class="num" data-val="88">000</span>
              <span class="text mt-1">Etudiants </span>
            </div>
            <div class="counterSection mr-3 mb-2">
              <i class="bi bi-building"></i>
              <a class="text" href="http://www.umi.ac.ma" target="_blank"><span class="mt-1">Université Moulay Ismail</span></a>
            </div>
            <div class="infoSection mr-2">
              <h4>Contacts :</h4>
              <i class="bi bi-instagram"></i><a href="https://www.instagram.com/acemmeknes/?hl=fr" title="Instagram ACEM" target="_blank"> acemmeknes</a> <br>
              <i class="bi bi-envelope-plus"></i><a href="mailto:acemmeknes2022@gmail.com"> acemmeknes2022@gmail.com</a>
            </div>
          </div>
          <!-- END INFO SECTION -->
            ...
            <div class="panel panel-default">
              ...
              <div id="collapseOne" class="panel-collapse collapse in">
                <div class="panel-body">
                  <p class="large">L’Association des Comoriens Etudiant au Maroc fût créée le 31 décembre 1981 à Casablanca, puis en suite une idée de décentralisation en section régionale a vu le jour telle est le cas de la ville de Meknès.
                    Le <b>25 février 2005</b>, fût ouverte la section régionale de Meknès. Elle a connu comme premier Secrétaire Général, <b>M. Dini Ibrahim Ali</b>, s'en ait suivi 18 autres étudiants qui ont brigué ce poste dont 6 Coordinateurs du Comité Elargi de l’ACEM (parmi eux l'actuel Ministre Conseiler auprès de l'Ambassade de l'Union des Comores au Maroc).
                  </p>
                  <p class="large">La ville de Meknès est l'une des anciennes et grandes villes du Royaume, comprenant ainsi le plus d’étudiants comoriens (cumules) où plusieurs activités nationales ont été réalisées, à savoir :</br>
                  <ul style="margin-left: 10px;">
                    <li style="margin-top:10px;">
                      <p><i class="fa fa-check-circle"></i> En 2006, la 4ème édition de la Journée Scientifique et Culturelle de l’étudiant comorien au Maroc.</p>
                    </li>
                    <li>
                      <p><i class="fa fa-check-circle"></i> En 2011, la 9ème édition de la Journée Scientifique et Culturelle de l’étudiant comorien au Maroc.</p>
                    </li>

                    <li>
                      <p><i class="fa fa-check-circle"></i> En 2013, la célébration du 32ème anniversaire de l’ACEM.</p>
                    </li>
                    <li>
                      <p><i class="fa fa-check-circle"></i> En 2015, la 13ème édition de la Journée Scientifique et Culturelle de l’étudiant comorien au Maroc.</p>
                    </li>
