              ...
              <div class="panel-group" id="accordion">
                ...
                <div class="panel panel-default border border-secondary">
                  <div class="panel-heading">
                    <p class="panel-title"> <a data-toggle="collapse " data-parent="#accordion" href="#collapseOne" style="text-align: center;">Liens des support ENSA Maroc</a> </p>
                  </div>
                  <div id="collapseOne" class="panel-collapse collapse in show">
                    <div class="panel-body">
                      <ul class="mt-2">
                        <li class="mt-2"><a href="https://www.concourat.com/ensa" title="visiter le site" target="_blank">ENSA CONCOURAT</a></li>
                        <li class="mt-2"><a href="https://www.9rayti.com/groupe/ensa" title="visiter le site" target="_blank">ENSA-9rayti.com</a></li>
                        <li class="mt-2"><a href="https://www.ensamaroc.com/" title="visiter le site" target="_blank">ENSA COURS & TD</a></li>
                        <li class="mt-2 mb-2"><a href="https://www.dates-concours.ma/articles-et-conseils/ensa-reseau-des-ecoles-nationales-des-sciences-appliquees/" title="visiter le site" target="_blank">ENSA CONSEILS</a></li>
                      </ul>
                    </div>
                  </div>
                </div>
