            ...
            <div class="col-md-12">
              <div class="full">
                <div class="main_heading1 text_align_center">
                  <p class="large"><h3>Ecole Nationales des Sciences Appliquées Au Maroc.<h3></p>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div class="accordion border_circle">
                  <div class="bs-example">
                    <div class="panel-group" id="accordion">
                      ...
                      <div class="panel panel-default border border-secondary">
                        <div class="panel-heading">
                          <p class="panel-title" > <a data-toggle="collapse " data-parent="#accordion" href="#collapseOne" style="text-align: center;">LIENS VERS DES ENSA MAROC</a> </p>
                        </div>
                        <div id="collapseOne" class="panel-collapse collapse in show">
                          <div class="panel-body">
                           <ul class="brand_list">
                            <li><a href="https://www.concourat.com/ensa" title="visiter le site" target="_blank">ENSA CONCOURAT</a></li>
                            <li><a href="https://www.9rayti.com/groupe/ensa" title="visiter le site" target="_blank">ENSA-9rayti.Com</a></li>
                            <li><a href="https://www.ensamaroc.com/" title="visiter le site" target="_blank">ENSA COURS & TD</a></li>
                            <li><a href="https://www.dates-concours.ma/articles-et-conseils/ensa-reseau-des-ecoles-nationales-des-sciences-appliquees/" title="visiter le site"  target="_blank">ENSA CONSEILS</a></li>  
                          </ul>
                        </div>
                      </div>
                    </div>
