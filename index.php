...
<body id="default_theme" class="it_service">
      ...
      <!-- header -->
      <?php require 'includes/body_header.php';  ?>
      <!-- end header -->


      <!--- section de Image--->
      <?php require 'includes/sectionImage.php'; ?>
      <!---- end section------>
            ...
            <div class="carousel-inner">
              <div class="carousel-item active">
                <div class="testimonial-container">
                  ...
                  <div class="testimonial-photo"> <img src="<?php echo URLROOT; ?>/assets/images/it_service/acem.jpg" class="img-responsive" alt="#" width="150" height="150"> </div>
